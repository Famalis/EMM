            ...
            <div class="section" id="section1">
                ...
                <div class="top" id="ustawienia">
                    <h1 ng-init="showLearnData = false" ng-click="showLearnData = !showLearnData">
						<img ng-show="showLearnData" width="20px" src="/TeaClassifier/resources/images/collapse.png">
						<img ng-hide="showLearnData" width="20px" src="/TeaClassifier/resources/images/expand.png">
						DANE NAUCZANIA</h1>
                    <div class="dane-testowe"   >
                        ...
                        <h1 ng-init="showQueryForm = true" ng-click="showQueryForm = !showQueryForm">
							<img ng-show="showQueryForm" width="20px" src="/TeaClassifier/resources/images/collapse.png">
							<img ng-hide="showQueryForm" width="20px" src="/TeaClassifier/resources/images/expand.png">
							ZAPYTANIE
						</h1>
                        <div class="pytania">
						...
						<div class="upload">
							<h1 ng-init="showUploadForm = true" ng-click="showUploadForm = !showUploadForm">
								<img ng-show="showUploadForm" width="20px" src="/TeaClassifier/resources/images/collapse.png">
								<img ng-hide="showUploadForm" width="20px" src="/TeaClassifier/resources/images/expand.png">
