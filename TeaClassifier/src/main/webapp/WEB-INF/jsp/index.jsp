        ...
        <div id="fullpage">
            ...
            <div class="section" id="section1">
                ...
                <div class="top" id="ustawienia">
                    <h1 ng-init="showLearnData = false" ng-click="showLearnData = !showLearnData">
                        <img ng-show="showLearnData" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/minus.png">
                        <img ng-hide="showLearnData" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/plus.png">
                        DANE NAUCZANIA</h1>
                    <div class="dane-testowe">

                        <ul ng-show="showLearnData">
                            <c:forEach var="item" items="${trainingSet}">
                                <li>${item}</li>
                                </c:forEach>
                        </ul>
                        <h1 ng-init="showQueryForm = true" ng-click="showQueryForm = !showQueryForm">
                            <img ng-show="showQueryForm" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/minus.png">
                            <img ng-hide="showQueryForm" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/plus.png">
                            ZAPYTANIE
                        </h1>
                        <div class="pytania">
                            <form name="queryForm" ng-show="showQueryForm"/>
                            Rodzaj herbaty:
                        ...
                        <h1 ng-init="showUploadForm = true" ng-click="showUploadForm = !showUploadForm">
                            <img ng-show="showUploadForm" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/minus.png">
                            <img ng-hide="showUploadForm" class="plus-minus" width="20px" src="/TeaClassifier/resources/images/plus.png">
                            ZAŁADUJ PLIK Z DANYMI DO NAUKI
                        </h1>
                        <div class="upload">
                                <form ng-show="showUploadForm" action='upload.htm' method='POST' enctype='multipart/form-data'>
                                    <input type='file' name='userFile'><br>
                                    <input type='submit' name='upload_btn' value='Wyślij'>
                                </form>
                            </div> 
